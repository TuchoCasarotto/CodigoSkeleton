		...
		*/
		...
		if (ACTIVIDADelegida == Detección_de_Distancia) {
			...
			case 0:
				...
				{
					Hueso(skeleton_mat, articulacion, 21, 17, _fluo, esqueleto_ancho + 5);	//	línea de caderas
...

				{
					...
					Hueso(skeleton_mat, articulacion, 21, 17, _red, esqueleto_ancho + 5);	//	línea de caderas
